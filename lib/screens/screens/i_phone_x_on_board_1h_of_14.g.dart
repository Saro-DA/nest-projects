...
class IPhoneXOnBoard1hOf14 extends StatefulWidget {
  const IPhoneXOnBoard1hOf14({Key? key}) : super(key: key);
  @override
  _IPhoneXOnBoard1hOf14 createState() => _IPhoneXOnBoard1hOf14();
}

class _IPhoneXOnBoard1hOf14 extends State<IPhoneXOnBoard1hOf14> {
  _IPhoneXOnBoard1hOf14();
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return ArrowsDefaultFw(
              ...
              ovrovrLine: Image.asset(
                'assets/images/I0_3464;0_3813.png',
                height: 11.061,
                width: 6.591,
        ...
        Positioned(
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return ArrowsDefaultFw(
              constraints,
              ovrovrLine: Image.asset(
                'assets/images/I0_3468;0_3813.png',
                height: 11.061,
                width: 6.591,
                fit: BoxFit.scaleDown,
              ),
              ...
              child: LayoutBuilder(builder: (context, constraints) {
                return ViewsAlertsXBackgroundLight(
                  ...
                  ovrovrPlatter: Image.asset(
                    'assets/images/I0_3476;0_3920.png',
