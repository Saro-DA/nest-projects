...
class IPhoneXOnBoard1gOf14 extends StatefulWidget {
  const IPhoneXOnBoard1gOf14({Key? key}) : super(key: key);
  @override
  _IPhoneXOnBoard1gOf14 createState() => _IPhoneXOnBoard1gOf14();
}

class _IPhoneXOnBoard1gOf14 extends State<IPhoneXOnBoard1gOf14> {
  _IPhoneXOnBoard1gOf14();
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return ArrowsDefaultFw(
              ...
              ovrovrLine: Image.asset(
                'assets/images/I0_3492;0_3813.png',
                height: 11.061,
                width: 6.591,
        ...
        Positioned(
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return ArrowsDefaultFw(
              constraints,
              ovrovrLine: Image.asset(
                'assets/images/I0_3496;0_3813.png',
                height: 11.061,
                width: 6.591,
                fit: BoxFit.scaleDown,
              ),
              ...
              child: LayoutBuilder(builder: (context, constraints) {
                return ViewsAlertsXBackgroundLight(
                  ...
                  ovrovrPlatter: Image.asset(
                    'assets/images/I0_3504;0_3920.png',
