...
class IPhoneXOnBoard10cOf14 extends StatefulWidget {
  const IPhoneXOnBoard10cOf14({Key? key}) : super(key: key);
  @override
  _IPhoneXOnBoard10cOf14 createState() => _IPhoneXOnBoard10cOf14();
}

class _IPhoneXOnBoard10cOf14 extends State<IPhoneXOnBoard10cOf14> {
  _IPhoneXOnBoard10cOf14();
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return ArrowsDefaultFw(
              ...
              ovrovrLine: Image.asset(
                'assets/images/I0_3278;0_3813.png',
                height: 11.061,
                width: 6.591,
        ...
        Positioned(
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return ArrowsDefaultFw(
              constraints,
              ovrovrLine: Image.asset(
                'assets/images/I0_3282;0_3813.png',
                height: 11.061,
                width: 6.591,
                fit: BoxFit.scaleDown,
              ),
          ...
          child: Stack(children: [
              ...
              child: LayoutBuilder(builder: (context, constraints) {
                return ViewsAlertsXBackgroundLight(
                  ...
                  ovrovrPlatter: Image.asset(
                    'assets/images/I0_3290;0_3920.png',
            ...
            Positioned(
              ...
              child: Container(
                  ...
                  width: 200.000,
                  child: AutoSizeText(
                    'Without Location Alunna may not be able to connect you with the right Instructor',
                    style: TextStyle(
