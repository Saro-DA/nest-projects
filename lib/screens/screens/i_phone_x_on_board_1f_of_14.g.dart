...
class IPhoneXOnBoard1fOf14 extends StatefulWidget {
  const IPhoneXOnBoard1fOf14({Key? key}) : super(key: key);
  @override
  _IPhoneXOnBoard1fOf14 createState() => _IPhoneXOnBoard1fOf14();
}

class _IPhoneXOnBoard1fOf14 extends State<IPhoneXOnBoard1fOf14> {
  _IPhoneXOnBoard1fOf14();
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return ArrowsDefaultFw(
              ...
              ovrovrLine: Image.asset(
                'assets/images/I0_3516;0_3813.png',
                height: 11.061,
                width: 6.591,
        ...
        Positioned(
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return ArrowsDefaultFw(
              constraints,
              ovrovrLine: Image.asset(
                'assets/images/I0_3521;0_3813.png',
                height: 11.061,
                width: 6.591,
                fit: BoxFit.scaleDown,
              ),
              ...
              child: LayoutBuilder(builder: (context, constraints) {
                return ViewsAlertsXBackgroundLight(
                  ...
                  ovrovrPlatter: Image.asset(
                    'assets/images/I0_3532;0_3920.png',
