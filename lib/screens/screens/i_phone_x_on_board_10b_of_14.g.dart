...
class IPhoneXOnBoard10bOf14 extends StatefulWidget {
  const IPhoneXOnBoard10bOf14({Key? key}) : super(key: key);
  @override
  _IPhoneXOnBoard10bOf14 createState() => _IPhoneXOnBoard10bOf14();
}

class _IPhoneXOnBoard10bOf14 extends State<IPhoneXOnBoard10bOf14> {
  _IPhoneXOnBoard10bOf14();
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return ArrowsDefaultFw(
              ...
              ovrovrLine: Image.asset(
                'assets/images/I0_3305;0_3813.png',
                height: 11.061,
                width: 6.591,
        ...
        Positioned(
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return ArrowsDefaultFw(
              constraints,
              ovrovrLine: Image.asset(
                'assets/images/I0_3309;0_3813.png',
                height: 11.061,
                width: 6.591,
                fit: BoxFit.scaleDown,
              ),
          ...
          child: Stack(children: [
              ...
              child: LayoutBuilder(builder: (context, constraints) {
                return ViewsAlertsXBackgroundLight(
                  ...
                  ovrovrPlatter: Image.asset(
                    'assets/images/I0_3317;0_3920.png',
            ...
            Positioned(
              ...
              child: Container(
                  ...
                  width: 200.000,
                  child: AutoSizeText(
                    'Without Notifications you may miss appointment reminders, messages, and more',
                    style: TextStyle(
