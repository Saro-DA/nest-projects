...
import 'package:alunna/controller/tag/enter_pin_custom.dart';
...
class IPhoneXOnBoard11Of14 extends StatefulWidget {
  const IPhoneXOnBoard11Of14({Key? key}) : super(key: key);
  @override
  _IPhoneXOnBoard11Of14 createState() => _IPhoneXOnBoard11Of14();
}

class _IPhoneXOnBoard11Of14 extends State<IPhoneXOnBoard11Of14> {
  _IPhoneXOnBoard11Of14();
    ...
    return Scaffold(
      ...
      body: Stack(children: [
              ...
              child: LayoutBuilder(builder: (context, constraints) {
                return BarsXBackgroundsNavigationBarCardStackLight(
                  ...
                  ovrovrMask: Image.asset(
                    'assets/images/I0_3263;0_3778.png',
        ...
        Positioned(
          ...
          top: 296.0,
          height: 72.0,
          child: EnterPinCustom(
              child: Image.asset(
            'assets/images/0_3264.png',
            height: 72.000,
            width: 250.000,
            fit: BoxFit.none,
          )),
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return SystemKeyboardsIPhoneLightNumbers(
              ...
              ovrovrDelete: Image.asset(
                'assets/images/I0_3270;0_3850.png',
