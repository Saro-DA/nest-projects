...
import 'package:zzz/widgets/small_major_card/small_major_card_loved.g.dart';
import 'package:zzz/widgets/responsive_orientation_builder.dart';
import 'package:zzz/models/small_major_card.dart';
import 'package:zzz/widgets/small_major_card/small_major_card_default.g.dart';
import 'package:auto_size_text/auto_size_text.dart';
import 'package:zzz/controller/majors_overview_page_appbar.dart';
import 'package:zzz/controller/majors_overview_page_tabbar.dart';
                ...
                var widget = LayoutBuilder(builder: (context, constraints) {
                  return SmallMajorCardLoved(
                    ...
                    ovrovrbackground: Image.asset(
                      'assets/images/I568_100;568_92.png',
                      width: 400.801,
                      height: 327.822,
                      fit: BoxFit.fill,
                    ),
              ...
              builder: (context, constraints) {
                var widget = LayoutBuilder(builder: (context, constraints) {
                  return SmallMajorCardLoved(
                    ...
                    ovrovrInformationSystems: 'Information Systems',
                    ovrovrbackground: Image.asset(
                      'assets/images/I568_109;568_92.png',
                      width: 400.801,
                      height: 327.822,
                      fit: BoxFit.fill,
                    ),
              ...
              builder: (context, constraints) {
                var widget = LayoutBuilder(builder: (context, constraints) {
                  return SmallMajorCardLoved(
                    ...
                    ovrovrInformationSystems: 'Information Systems',
                    ovrovrbackground: Image.asset(
                      'assets/images/I568_118;568_92.png',
                      width: 400.801,
                      height: 327.822,
                      fit: BoxFit.fill,
                    ),
              ...
              builder: (context, constraints) {
                var widget = LayoutBuilder(builder: (context, constraints) {
                  return SmallMajorCardLoved(
                    ...
                    ovrovrInformationSystems: 'Information Systems',
                    ovrovrbackground: Image.asset(
                      'assets/images/I568_127;568_92.png',
                      width: 400.801,
                      height: 327.822,
                      fit: BoxFit.fill,
                    ),
              ...
              builder: (context, constraints) {
                var widget = LayoutBuilder(builder: (context, constraints) {
                  return SmallMajorCardLoved(
                    ...
                    ovrovrInformationSystems: 'Information Systems',
                    ovrovrbackground: Image.asset(
                      'assets/images/I568_136;568_92.png',
                      width: 400.801,
                      height: 327.822,
                      fit: BoxFit.fill,
                    ),
              ...
              builder: (context, constraints) {
                var widget = LayoutBuilder(builder: (context, constraints) {
                  return SmallMajorCardLoved(
                    ...
                    ovrovrInformationSystems: 'Information Systems',
                    ovrovrbackground: Image.asset(
                      'assets/images/I568_145;568_92.png',
                      width: 400.801,
                      height: 327.822,
                      fit: BoxFit.fill,
                    ),
